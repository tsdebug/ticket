                            ...
                            <CardContent className="p-0 relative">
                                ...
                                <div className="p-4">
                                    ...
                                    <div className="flex items-center justify-between mt-4">
                                        ...
                                        {isComingSoon ? (
                                            <Button variant="outline" className="border-purple-200 text-purple-700">Remind Me</Button>
                                        ) : (
                                            <Link href={`/book/${movie.id}`}>
                                                <Button className="bg-purple-600 hover:bg-purple-700 text-white">Book Ticket</Button>
                                            </Link>
                                        )}
                                    </div>
                                </div>
